...
const Navbar = ({ user }) => {
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-white/20 backdrop-blur-md shadow-md border-b border-teal-200 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2">
              <img src={logo} alt="logo" className="w-8 h-8" />
              <span className="text-xl font-bold bg-gradient-to-r from-teal-400 to-blue-700 bg-clip-text text-transparent">
                Photo Learn
              </span>
            </Link>
          </div>
